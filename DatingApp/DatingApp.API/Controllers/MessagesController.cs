...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetMessageThread(int userId, int recipientId){
            ...
            var mesagesfromRepo = await _repo.GetMessageThread(userId, recipientId);
            var messageThread= _mapper.Map<IEnumerable<MessageToReturnDto>>(mesagesfromRepo);
        ...
        [HttpPost("{id}/read")]
        public async Task<IActionResult> MartMessageAsRead(int userId, int id)
        {
             if(userId != int.Parse(User.FindFirst(ClaimTypes.NameIdentifier).Value)){
                return Unauthorized();
            }
